...
color black1 = color(100, 100, 100);
 ...
 //  print(x,":",y," ",mouseX,":",mouseY," ");
   if (mouseX< x+40 && mouseX >x-10 && mouseY>y+20){
    y=y+5;
    if (pixels[800*(y+bly-1)+x]==black || pixels[800*(y+bly-1)+x]==black1){
     y=prey;
     print(pixels[800*(y+4+bly)+x]);
    } else
     print(pixels[800*(y+bly-1)+x]);   
   } else    if (mouseX <x+40 && mouseX >x-10 && mouseY<y){
     y=y-5;
    if(y<0) y=0;
    if (pixels[800*(y+1)+x]==black || pixels[800*(y+1)+x]==black1){
     y=prey;
     print(pixels[800*(y+4)+x]);
    } else
     print(pixels[800*(y+1)+x]);

   } else    if (mouseX <x-1 && mouseY >y-20 && mouseY<y+30){
    x=x-5;
    if(x<0) x=0;
   ...
   } else   if (mouseX >x+20 && mouseY >y-20 && mouseY<y+30){
    x=x+5;
    if (pixels[800*y+x+blx-1]==black || pixels[800*y+x+blx-1]==black1){
     x=prex;
     print(pixels[800*y+x+5+blx-1]);
    } else
     print(pixels[800*y+x+blx-1]);
   } 
